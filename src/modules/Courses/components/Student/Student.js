        ...
        return (
            <div
                className={`${style.card} ${
                    this.props.student.active === true
                        ? style["card-active"]
                        : ""
                }`}
                onClick={e =>
                    this.props.addtocompare(`${this.props.student.id}`)
                }
            >
                ...
                <div
                    className={`${style["upper-right"]} ${
                        this.props.student.active === true ? style.active : ""
                    }`}
                >
                    <h2 className={style.check}>✔</h2>
                </div>
                <div
                    className={`${style["bottom-right"]} ${
                        this.props.student.active === true ? style.active : ""
                    }`}
                >
